    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="auto-style25">
        <table class="auto-style24">
            <tr>
                ...
                <td class="auto-style23"><strong>ONAYSIZ ÖNERİ LİSTESİ</strong></td>
            </tr>
        </table>
    </asp:Panel>   
    ...
    <asp:Panel ID="Panel3" runat="server" CssClass="auto-style25">
        <table class="auto-style24">
            <tr>
                ...
                <td class="auto-style23"><strong>ONAYLI ÖNERİ LİSTESİ</strong></td>
            </tr>
        </table>
    </asp:Panel>   
    <asp:Panel ID="Panel4" runat="server" CssClass="auto-style25">
         <asp:DataList ID="DataList2" runat="server" Width="444px" CssClass="auto-style25">
            <ItemTemplate>
                <table class="auto-style3">
                    <tr>
                        <td class="auto-style29">
