                ...
                <table class="auto-style3">
                    <tr>
                        ...
                        <td class="auto-style22">
                            ...
                            <a href="YemekAdminDetay.aspx?Yemekid=<%#Eval("Yemekid")%>">
    ...
    <asp:Panel ID="Panel3" runat="server" CssClass="auto-style9">
        <table class="auto-style3">
            <tr>
                ...
                <td><strong><span class="auto-style18">YEMEK EKLE</span></strong></td>
            </tr>
        </table>
    </asp:Panel>
    <asp:Panel ID="Panel4" runat="server" CssClass="auto-style10">
        <table class="auto-style3">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="BtnEkle" runat="server" CssClass="tb5" OnClick="BtnEkle_Click" Text="Ekle" />
                </td>
            </tr>
            <tr>
                <td class="auto-style7">&nbsp;</td>
